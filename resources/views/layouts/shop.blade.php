...
<body class="d-flex flex-column min-vh-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm mb-4">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}"><i class="bi bi-shop"></i> {{ config('app.name', 'Toko Online Wong Tulus') }}</a>
    ...
    <footer class="bg-dark text-white py-4 mt-auto">
        <div class="container text-center">
            <p class="mb-0">&copy; {{ date('Y') }} {{ config('app.name', 'Toko Online Wong Tulus') }}. All rights reserved.</p>
        </div>
    </footer>
